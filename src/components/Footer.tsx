        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/919865460607" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-4 text-sm text-ivory/75">
              <li className="flex items-start gap-3">
                ...
                28, Siva Sakthi Colony, Kuruchi, SIDCO Post, Coimbatore, Tamil Nadu, 641021
              </li>
